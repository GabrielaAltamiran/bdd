...
(49852,17559,'15/09/2022','1000'),
(10025,17560,'09/11/2022','985'),
(95201,17561,'25/12/2022','807.20'),
(27384,17545,'10/02/2023','996')
...
--...........................Reto 25.....................................................
select AVG(cast(saldo as numeric)) as saldo_promedio from 
cuentas cu, usuario usu
where cu.cedula_propetario = usu.cedula and cedula = '17561'
group by cu.saldo
--.......................................................................................
select tipo_cuenta,count(tipo_cuenta) as total_cuentas from 
cuentas cu, usuario usu
where cu.cedula_propetario = usu.cedula and tipo_cuenta = 'Ahorros'
group by usu.tipo_cuenta
--...........................terminación del Reto 25.....................................